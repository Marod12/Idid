...
@section('content')
                    ...
                    <article class="post">
                        <header class="post__header">
                            ...
                            @if($receita->idid != null)
                                <button onclick="openDiv('ididReceita{{ $receita->idid }}')">    
                        ...
                        <nav class="post__controls">
                            ...
                            @if($receita->author != Auth::user()->id)
    ...
    @if($receita->idid != null)
        <div id="ididReceita{{ $receita->idid }}" style="display: none;">
            <div class="container">
                <div class="cadastro-receita-container">
                    <section class="feed">
                            <article class="post">
                                ...
                                <figure class="post__figure">
                                    @if($receitaI->foto == null)
                                        <img src="/storage/padrao/cooking.jpg">
                                    @else
                                        <img src="/storage/{{ $receitaI->foto }}" alt="imagem da receita">
                                    @endif
                                </figure>
                                
                                <div class="post-content">
                                    <div>
                                        <h1>{{ $receitaI->title }}</h1>
                                    </div>
                                    <p>
                                        {{ $receitaI->descricao }}
                                    </p>
                                    ...
                                    <h2>Ingredientes</h2>
                                    <pre>{{$receitaI->ingredientes}}</pre>
                                    
                                    <h2>Modo de Preparo</h2>
                                    <div class="modoPreparo">
                                        <p1>
                                            {{$receitaI->modoPreparo}}
                                        </p1>
                                    </div>    
                                </div>
